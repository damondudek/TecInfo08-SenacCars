  ...
  <body>
    <div class="container-fluid bg-dark">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">SenacCars</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <button onclick="entrar()" class="btn btn-outline-success my-2 my-sm-0" type="submit">Entrar</button>
        </div>
      </nav>
    </div>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="./img/car1.jpg" class="d-block w-100" alt="Imagem de um carro">
          </div>
          <div class="carousel-item">
            <img src="./img/car2.jpg" class="d-block w-100" alt="Imagem de um carro">
          </div>
          <div class="carousel-item">
            <img src="./img/car3.jpg" class="d-block w-100" alt="Imagem de um carro">
          </div>
          <div class="carousel-item">
            <img src="./img/car3.jpg" class="d-block w-100" alt="Imagem de um carro">
          </div>
